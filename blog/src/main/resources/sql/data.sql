INSERT INTO posts (id, body, title)
VALUES (1, 'We have great news! We are finishing our course on the Spring', 'Code Club News');

INSERT INTO posts (id, body, title)
VALUES (2, 'We have great news! We are finishing our course on the Java', 'Code Club News');

INSERT INTO comments (id, body)
VALUES (1, 'Wow, that is great!!!');

INSERT INTO comments (id, body)
VALUES (2, 'Cool, I want to learn spring too!!!,');
